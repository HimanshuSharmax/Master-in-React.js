...
function App() {
  ...
  return (
    ...
    style={{backgroundColor: color}}>
      <div className="fixed flex flew-wrap justify-center bottom-16 inset-x-1 px-2">
        <div className="flex flex-wrap gap-2 justify-center shadow-lg bg-white px-3 py-2
        rounded-xl">
          ...
          <button onClick={()=>setColor("pink")}  className="outline-none px-4 py-1 rounded-full text-black shadow-xl"
          style={{backgroundColor:"pink"}}>Pink</button>
          <button onClick={()=>setColor("yellow")}  className="outline-none px-4 py-1 rounded-full text-black shadow-xl"
          style={{backgroundColor:"yellow"}}>Yellow</button>
          <button onClick={()=>setColor("grey")}  className="outline-none px-4 py-1 rounded-full text-white shadow-xl"
          style={{backgroundColor:"grey"}}>Grey</button>
        </div>
       </div>
        default Colour "Olive"
    </div>
  )
}
